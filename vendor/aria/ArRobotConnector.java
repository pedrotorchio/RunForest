...
public class ArRobotConnector {
  ...
  public ArRobotConnector(ArArgumentParser parser, ArRobot robot, boolean autoParseArgs, boolean connectAllComponents) {
    this(AriaJavaJNI.new_ArRobotConnector__SWIG_0(ArArgumentParser.getCPtr(parser), parser, ArRobot.getCPtr(robot), robot, autoParseArgs, connectAllComponents), true);
  }

  public ArRobotConnector(ArArgumentParser parser, ArRobot robot, boolean autoParseArgs) {
    this(AriaJavaJNI.new_ArRobotConnector__SWIG_1(ArArgumentParser.getCPtr(parser), parser, ArRobot.getCPtr(robot), robot, autoParseArgs), true);
  }

  public ArRobotConnector(ArArgumentParser parser, ArRobot robot) {
    this(AriaJavaJNI.new_ArRobotConnector__SWIG_2(ArArgumentParser.getCPtr(parser), parser, ArRobot.getCPtr(robot), robot), true);
  }
  ...
  public void setRemoteIsSim(boolean remoteIsSim) {
    AriaJavaJNI.ArRobotConnector_setRemoteIsSim(swigCPtr, this, remoteIsSim);
  }
  ...
  public boolean disconnectAll() {
    return AriaJavaJNI.ArRobotConnector_disconnectAll(swigCPtr, this);
  }
