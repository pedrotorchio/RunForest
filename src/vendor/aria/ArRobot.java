...
public class ArRobot {
  ...
  public void run() {
    AriaJavaJNI.ArRobot_run__SWIG_2(swigCPtr, this);
  }

  public void runAsync() {
    AriaJavaJNI.ArRobot_runAsync__SWIG_2(swigCPtr, this);
  }
  ...
  public long getNumLasers() {
    return AriaJavaJNI.ArRobot_getNumLasers(swigCPtr, this);
  }
  ...
  public SWIGTYPE_p_DWORD getOSThread() {
    return new SWIGTYPE_p_DWORD(AriaJavaJNI.ArRobot_getOSThread(swigCPtr, this), true);
  }
  ...
  public ArSyncTask addUserTask(ArFunctor functor, String name) {
    long cPtr = AriaJavaJNI.ArRobot_addUserTask__SWIG_2(swigCPtr, this, ArFunctor.getCPtr(functor), functor, name);
    return (cPtr == 0) ? null : new ArSyncTask(cPtr, false);
  }

  public ArSyncTask addUserTask(ArFunctor functor) {
    long cPtr = AriaJavaJNI.ArRobot_addUserTask__SWIG_3(swigCPtr, this, ArFunctor.getCPtr(functor), functor);
    return (cPtr == 0) ? null : new ArSyncTask(cPtr, false);
  }

  public ArSyncTask addSensorInterpTask(ArFunctor functor, String name) {
    long cPtr = AriaJavaJNI.ArRobot_addSensorInterpTask__SWIG_2(swigCPtr, this, ArFunctor.getCPtr(functor), functor, name);
    return (cPtr == 0) ? null : new ArSyncTask(cPtr, false);
  }

  public ArSyncTask addSensorInterpTask(ArFunctor functor) {
    long cPtr = AriaJavaJNI.ArRobot_addSensorInterpTask__SWIG_3(swigCPtr, this, ArFunctor.getCPtr(functor), functor);
    return (cPtr == 0) ? null : new ArSyncTask(cPtr, false);
  }

  public void removeTask(String name) {
    AriaJavaJNI.ArRobot_removeTask__SWIG_0(swigCPtr, this, name);
  }

  public boolean replaceSensorInterpTask(ArFunctor newFunctor, String name) {
    return AriaJavaJNI.ArRobot_replaceSensorInterpTask(swigCPtr, this, ArFunctor.getCPtr(newFunctor), newFunctor, name);
  }

  public boolean replaceUserTask(ArFunctor newFunctor, String name) {
    return AriaJavaJNI.ArRobot_replaceUserTask(swigCPtr, this, ArFunctor.getCPtr(newFunctor), newFunctor, name);
  }

  public void removeTask(ArFunctor f) {
    AriaJavaJNI.ArRobot_removeTask__SWIG_1(swigCPtr, this, ArFunctor.getCPtr(f), f);
  }
