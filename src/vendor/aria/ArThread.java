...
public class ArThread {
  ...
  public ArThread(SWIGTYPE_p_DWORD thread, boolean joinable, boolean blockAllSignals) {
    this(AriaJavaJNI.new_ArThread__SWIG_2(SWIGTYPE_p_DWORD.getCPtr(thread), joinable, blockAllSignals), true);
  }

  public ArThread(SWIGTYPE_p_DWORD thread, boolean joinable) {
    this(AriaJavaJNI.new_ArThread__SWIG_3(SWIGTYPE_p_DWORD.getCPtr(thread), joinable), true);
  }
  ...
  public static SWIGTYPE_p_DWORD osSelf() {
    return new SWIGTYPE_p_DWORD(AriaJavaJNI.ArThread_osSelf(), true);
  }
  ...
  public SWIGTYPE_p_DWORD getThread() {
    long cPtr = AriaJavaJNI.ArThread_getThread(swigCPtr, this);
    return (cPtr == 0) ? null : new SWIGTYPE_p_DWORD(cPtr, false);
  }

  public SWIGTYPE_p_DWORD getOSThread() {
    return new SWIGTYPE_p_DWORD(AriaJavaJNI.ArThread_getOSThread(swigCPtr, this), true);
  }
  ...
  public static SWIGTYPE_p_DWORD getThisThread() {
    long cPtr = AriaJavaJNI.ArThread_getThisThread();
    return (cPtr == 0) ? null : new SWIGTYPE_p_DWORD(cPtr, false);
  }

  public static SWIGTYPE_p_DWORD getThisOSThread() {
    return new SWIGTYPE_p_DWORD(AriaJavaJNI.ArThread_getThisOSThread(), true);
  }
