...
public class ArBasePacket {
  ...
  public void bufToStr(String buf, int maxlen) {
    AriaJavaJNI.ArBasePacket_bufToStr(swigCPtr, this, buf, maxlen);
  }

  public String bufToString() {
    return AriaJavaJNI.ArBasePacket_bufToString(swigCPtr, this);
  }
