...
public class ArPose {
  ...
  public static boolean compareX(ArPose p1, ArPose p2) {
    return AriaJavaJNI.ArPose_compareX(ArPose.getCPtr(p1), p1, ArPose.getCPtr(p2), p2);
  }

  public static boolean compareY(ArPose p1, ArPose p2) {
    return AriaJavaJNI.ArPose_compareY(ArPose.getCPtr(p1), p1, ArPose.getCPtr(p2), p2);
  }

  public boolean isInsidePolygon(ArPoseVector vertices) {
    return AriaJavaJNI.ArPose_isInsidePolygon(swigCPtr, this, ArPoseVector.getCPtr(vertices), vertices);
  }
