...
public class ArActionLimiterForwards extends ArAction {
  ...
  public boolean getStopped() {
    return AriaJavaJNI.ArActionLimiterForwards_getStopped(swigCPtr, this);
  }

  public ArPose getLastSensorReadingPos() {
    return new ArPose(AriaJavaJNI.ArActionLimiterForwards_getLastSensorReadingPos(swigCPtr, this), true);
  }

  public ArRangeDevice getLastSensorReadingDevice() {
    long cPtr = AriaJavaJNI.ArActionLimiterForwards_getLastSensorReadingDevice(swigCPtr, this);
