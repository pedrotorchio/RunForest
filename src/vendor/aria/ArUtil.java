...
public class ArUtil {
  ...
  public static int open(String pathname, int flags, int mode, boolean closeOnExec) {
    return AriaJavaJNI.ArUtil_open__SWIG_2(pathname, flags, mode, closeOnExec);
  }

  public static int open(String pathname, int flags, int mode) {
    return AriaJavaJNI.ArUtil_open__SWIG_3(pathname, flags, mode);
  }
  ...
  public static int creat(String pathname, int mode, boolean closeOnExec) {
    return AriaJavaJNI.ArUtil_creat__SWIG_0(pathname, mode, closeOnExec);
  }

  public static int creat(String pathname, int mode) {
    return AriaJavaJNI.ArUtil_creat__SWIG_1(pathname, mode);
  }
