...
public class ArMapScan extends ArMapScanInterface {
  ...
  public void setPoints(ArPoseVector points, String scanType, boolean isSortedPoints, SWIGTYPE_p_ArMapChangeDetails changeDetails) {
    AriaJavaJNI.ArMapScan_setPoints__SWIG_0(swigCPtr, this, ArPoseVector.getCPtr(points), points, scanType, isSortedPoints, SWIGTYPE_p_ArMapChangeDetails.getCPtr(changeDetails));
  }

  public void setPoints(ArPoseVector points, String scanType, boolean isSortedPoints) {
    AriaJavaJNI.ArMapScan_setPoints__SWIG_1(swigCPtr, this, ArPoseVector.getCPtr(points), points, scanType, isSortedPoints);
  }

  public void setPoints(ArPoseVector points, String scanType) {
    AriaJavaJNI.ArMapScan_setPoints__SWIG_2(swigCPtr, this, ArPoseVector.getCPtr(points), points, scanType);
  }

  public void setPoints(ArPoseVector points) {
    AriaJavaJNI.ArMapScan_setPoints__SWIG_3(swigCPtr, this, ArPoseVector.getCPtr(points), points);
  }
  ...
  public void setLines(ArLineSegmentVector lines, String scanType, boolean isSortedLines, SWIGTYPE_p_ArMapChangeDetails changeDetails) {
    AriaJavaJNI.ArMapScan_setLines__SWIG_0(swigCPtr, this, ArLineSegmentVector.getCPtr(lines), lines, scanType, isSortedLines, SWIGTYPE_p_ArMapChangeDetails.getCPtr(changeDetails));
  }

  public void setLines(ArLineSegmentVector lines, String scanType, boolean isSortedLines) {
    AriaJavaJNI.ArMapScan_setLines__SWIG_1(swigCPtr, this, ArLineSegmentVector.getCPtr(lines), lines, scanType, isSortedLines);
  }

  public void setLines(ArLineSegmentVector lines, String scanType) {
    AriaJavaJNI.ArMapScan_setLines__SWIG_2(swigCPtr, this, ArLineSegmentVector.getCPtr(lines), lines, scanType);
  }

  public void setLines(ArLineSegmentVector lines) {
    AriaJavaJNI.ArMapScan_setLines__SWIG_3(swigCPtr, this, ArLineSegmentVector.getCPtr(lines), lines);
  }
