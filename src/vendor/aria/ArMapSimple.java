...
public class ArMapSimple extends ArMapInterface {
  ...
  public void setPoints(ArPoseVector points, String scanType, boolean isSortedPoints, SWIGTYPE_p_ArMapChangeDetails changeDetails) {
    AriaJavaJNI.ArMapSimple_setPoints__SWIG_0(swigCPtr, this, ArPoseVector.getCPtr(points), points, scanType, isSortedPoints, SWIGTYPE_p_ArMapChangeDetails.getCPtr(changeDetails));
  }

  public void setPoints(ArPoseVector points, String scanType, boolean isSortedPoints) {
    AriaJavaJNI.ArMapSimple_setPoints__SWIG_1(swigCPtr, this, ArPoseVector.getCPtr(points), points, scanType, isSortedPoints);
  }

  public void setPoints(ArPoseVector points, String scanType) {
    AriaJavaJNI.ArMapSimple_setPoints__SWIG_2(swigCPtr, this, ArPoseVector.getCPtr(points), points, scanType);
  }

  public void setPoints(ArPoseVector points) {
    AriaJavaJNI.ArMapSimple_setPoints__SWIG_3(swigCPtr, this, ArPoseVector.getCPtr(points), points);
  }
  ...
  public void setLines(ArLineSegmentVector lines, String scanType, boolean isSortedLines, SWIGTYPE_p_ArMapChangeDetails changeDetails) {
    AriaJavaJNI.ArMapSimple_setLines__SWIG_0(swigCPtr, this, ArLineSegmentVector.getCPtr(lines), lines, scanType, isSortedLines, SWIGTYPE_p_ArMapChangeDetails.getCPtr(changeDetails));
  }

  public void setLines(ArLineSegmentVector lines, String scanType, boolean isSortedLines) {
    AriaJavaJNI.ArMapSimple_setLines__SWIG_1(swigCPtr, this, ArLineSegmentVector.getCPtr(lines), lines, scanType, isSortedLines);
  }

  public void setLines(ArLineSegmentVector lines, String scanType) {
    AriaJavaJNI.ArMapSimple_setLines__SWIG_2(swigCPtr, this, ArLineSegmentVector.getCPtr(lines), lines, scanType);
  }

  public void setLines(ArLineSegmentVector lines) {
    AriaJavaJNI.ArMapSimple_setLines__SWIG_3(swigCPtr, this, ArLineSegmentVector.getCPtr(lines), lines);
  }
