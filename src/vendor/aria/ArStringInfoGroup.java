...
public class ArStringInfoGroup {
  ...
  public boolean addStringString(String name, int maxLen, SWIGTYPE_p_ArRetFunctorT_std__string_t functor) {
    return AriaJavaJNI.ArStringInfoGroup_addStringString__SWIG_2(swigCPtr, this, name, maxLen, SWIGTYPE_p_ArRetFunctorT_std__string_t.getCPtr(functor));
  }
